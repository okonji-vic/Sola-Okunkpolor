...
class UserCourseMobile extends StatefulWidget {
  Function(dynamic) navigateTo;

  UserCourseMobile({super.key, required this.navigateTo});

  @override
  State<UserCourseMobile> createState() => _UserCourseMobileState();
}

class _UserCourseMobileState extends State<UserCourseMobile> {
